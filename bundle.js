...
var startOfWeek = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_date_fns_format__ = __webpack_require__(21);
...
const RegisterHtmlTemplate = __webpack_require__(20);

RegisterHtmlTemplate.register("<dom-module id=my-element> <template> <h1>Hello, World! It's [[today]].</h1> </template> </dom-module>");
  ...
  static get properties() {
    return {
      today: {
        type: String,
        value: function () {
          return __WEBPACK_IMPORTED_MODULE_0_date_fns_format___default()(new Date(), 'MM/DD/YYYY');
        }
      }
    };
  }
...
var getDayOfYear = __webpack_require__(22);
